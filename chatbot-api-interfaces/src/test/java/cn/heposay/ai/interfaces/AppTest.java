...
public class AppTest {
    ...
    private static final String OPEN_AI_KEY = "xxx";
    ...
    public void query_zsxq_answers_test() throws IOException {
        ...
        if (response.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
            ...
            logger.info("请求成功，结果：{}" + res);
        } else {
            logger.error("请求失败，失败原因：{}", response.getStatusLine().getStatusCode());
        }
    }
    ...
    public void test_openapi() throws IOException {
        ...
        String paramJson = "{\"model\": \"gpt-3.5-turbo\",\"messages\": [{\"role\": \"user\",\"content\": \"帮我写一个冒泡排序!\"}]}";
